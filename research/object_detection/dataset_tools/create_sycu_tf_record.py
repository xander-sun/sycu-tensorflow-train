...
#                     mask_type='png'
  ...
  with contextlib2.ExitStack() as tf_record_close_stack:
    ...
    for idx, example in enumerate(examples):
      ...
      name_lst = example.split("\t")

      xml_path = os.path.join(annotations_dir, name_lst[2], name_lst[0] + '.xml')
...
def main(_):
  ...
  logging.info('Reading from SYCU dataset.')
  ...
  train_output_path = os.path.join(FLAGS.output_dir, 'sycu_train.record')
  val_output_path = os.path.join(FLAGS.output_dir, 'sycu_val.record')
