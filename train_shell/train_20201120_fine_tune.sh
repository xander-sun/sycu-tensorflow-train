...
train_code_path="/home/ys/tensorflow_test/train_code/sycu-tensorflow-train/research/object_detection/"
python3 ${train_code_path}model_main_tf2.py \
--alsologtostderr \
--model_dir="/home/ys/tensorflow_test/nets/sycu_ssd_mobilenet_v1_fpn_keras" \
